...
def load_model(key):
    ...
    modelDecoder = load_lite_decoder(modelAurora)
...
#           )
        ...
        # --- loss setup ---
        criterion = LossCriterion(train_dataset.dataset._get_stat_data()['lsm'])
        ...
        # --- training loop ---
        # train
        for epoch in range(1, train_hydr.config.train.epochs + 1):
            if train_hydr.config.train.use_dist:
