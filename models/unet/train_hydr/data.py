...
#       'precipitation': 'precipitation'
    ...
    def set_normalization():
        ...
        locations['precipitation'], scales['precipitation'] = 3.37594, 4.8210 # log transform
    ...
    def __getitem__(self, idx: int):
        ...
        input_dict = {}
        input_dict.update(self._get_hydr_data(end_idx -1, end_idx))
        input_dict.update(self._get_et_data(end_idx -1, end_idx))
        input_dict.update(self._get_p_data(end_idx -1, end_idx))
        ...
        return (input_batch, input_dict), target_dict
    ...
    def get_static_var_data(self, key):
        val = self.stat_ds[key].values[0]
        val = self._adjust_longitude(val, self.stat_ds['longitude'].values)
        val = self._adjust_latitude(val)
        return val
